...
$mobile='https://goldenbeachgroup.com/app/driver_master/';
...
<a href="<?=$mobile?>"   id="auto"  onclick="self.close()"> 
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    <tr>
      <td align="center"><b><a href="app://tb-driver"><img src="../images/applogo.png" id="login_logo" width="280" border="0" align="absbottom"  style="margin-top:-5px;text-shadow:  5px 3px #666666; cursor:pointer "   /></a></b>
        <table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tbody>
            <tr>
              <td align="center" style="font-size:26px;"><strong>คลิกเพื่อเข้าสู่ระบบ</strong></td>
            </tr>
            <tr>
              <td align="center" style="font-size:28px;"><strong>T-BOOKING</strong></td>
            </tr>
          </tbody>
      </table></td>
    </tr>
