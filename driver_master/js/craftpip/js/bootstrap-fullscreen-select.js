    ...
    Mobileselect.prototype = {
        ...
        _appendOptionsList: function () {
            ...
            $.each(this.options, function (i, a) {
               ...
               var  tell = "";
               var all = "";
              if (a.text.indexOf('json:') > -1){
			  	 var ob_txt = a.text.split("json:");
                 var obj = JSON.parse(ob_txt[1]);
//             	 console.log(obj);
             	 text = obj.name;
             	 username = obj.username;
             	 if(obj.company!=""){
				 	company = '<br>'+obj.company;
				 }
				 if (obj.phone.indexOf('/') > -1)
					{
					  	var phone2 = obj.phone.split("/");
					  	var tell2 =  '<span onclick="TelDriver(\'' + phone2[1]+ '\');" style="color: #fffff;" >โทร : '+phone2[1]+'</span>';
					  	var tell = '<span onclick="TelDriver(\'' + phone2[0]+ '\');" style="color: #fffff;" >โทร : '+phone2[0]+'</span>'+'<br/>'+tell2;

					}else{
						var tell = '<span onclick="TelDriver(\'' + obj.phone+ '\');" style="color: #fffff;" >โทร : '+obj.phone+'</span>';
					}
             	
             	 all = username + company + '<br/>' + tell;
			  }
             
              	
that.$listcontainer.append('<a href="#" class="mobileSelect-control" ' + b +' data-value="' + a.value + '"  >'+ div_color + text + all +'</a>');
