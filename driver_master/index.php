...
<?  include "load/popup_main.php" ;?>

<?  include "load/popup_main_acc.php" ;?>
<?  include "load/popup_gps.php" ;?>
<?  include "load/popup_check_car.php" ;?>
<?  include ("load/popup_check_in.php");?>
<?  include ("load/popup_checkin.php");?>
<?  include ("load/popup_pay.php");?>
<?  include ("load/popup_checkwork.php");?>
</div>
<!-- End Content -->
...
.btnstatus-checkin{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; height: 50px; font-size:20px; width:100%; margin-right:15px; background-color:#367FA9;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;

}


.btnstatus-checkin-red{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; height: 50px; font-size:20px; width:100%; margin-right:15px; background-color:#ff2b2b;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;

}

 

.btnstatus-checkin-no{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; height: 50px; font-size:20px; width:100%; margin-right:15px; background-color:#1CC1A4;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;  pointer-events:none;
...
.btnstatus-checkin-no:hover{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; height: 50px; font-size:20px; width:100%; margin-right:15px; background-color:#1CC1A4;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;  pointer-events:none;
...
.btnstatus-checkin-red:active{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; height: 50px; font-size:20px; width:100%; margin-right:15px; background-color:#ff2b2b;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;
...
border-radius: 20px;padding:5px; height: 50px; font-size:14px; width:100px; margin-right:15px; background-color:#367FA9;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF;

}


.btn-modal-ok{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px;height: 50px; font-size:24px; width:100%; background-color:#1CC1A4;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF; margin-top:15px;
...
border-radius: 25px;padding:5px; font-size:24px;height: 50px;  width:100%; background-color:<?=$no_button_color?>;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF; margin-top:15px;
}

.btn-modal-no-popup{ box-shadow: 1px 1px 5px #999999; border:0px solid #FFFFFF; 
border-radius: 25px;padding:5px; font-size:24px;height: 50px;  width:100%; background-color:<?=$no_button_color?>;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF; margin-top:15px;
}
...
function getLocation(position) {
	console.log('Now lat : '+ position.coords.latitude);
	console.log('Now lng : '+ position.coords.longitude);
	
	if(position.coords.latitude!=0){
	$('#check_data_status_gps_lat_old').val(position.coords.latitude);
	}
	if(position.coords.longitude!=0){
	$('#check_data_status_gps_lng_old').val(position.coords.longitude);
	}
}   

function findDistance(lat_from,lat_to,lng_from,lng_to){
	
	var radlat1 = Math.PI * lat_from.driver_topoint_lat / 180
    var radlat2 = Math.PI * lat_to / 180
    var theta = lng_from - lng_to;
