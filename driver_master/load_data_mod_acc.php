...
?>    
  ...
  $('.back-full-popup-mod-button-show-acc').click(function(){   

  $( "#load_data_main_popup_acc" ).toggle();
 
  $( "#load_data_main_popup_acc" ).html();
  ...
  <tr>
    <td width="40"   ><div class="back-full-popup-mod-button-show-acc" ><i class="fa fa-arrow-circle-left" style="font-size:22px; color:#FFFFFF "></div></i></td>
  <td   ><div style="font-size:18px; color:#FFFFFF " id="head_full_popup_acc"></div></td>
