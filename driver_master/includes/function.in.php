...
function check_work_today($driver = ""){
//
 global $db ;
 
	if($driver_company==1133) {
...
echo $allwork = $db->num_rows(TB_transfer_report_all,"id","drivername='".$driver."'  $find_date  and status = 'CONFIRM' group by invoice    "); 
}
...
function check_driver_action($company = ""){
...
function check_driver_use_car($driver = "",$company = ""){
...
//// echo $all_dv = $db->num_rows(TB_driver,"id","status=1 and status_work=1 and company=".$company."");
...
function check_driver_phone($driver = "",$company = ""){
//
 global $db ;
...
echo $all_dv = $db->num_rows(TB_driver,"id","status=1 and status_work=1 and(company=276 or company=283 or company=284 or company=3992 or company=3993 or company=3994 or company=3996)");
...
function check_callcenter_phone($driver = "",$company = ""){
//
 global $db ;
...
echo $all_call = $db->num_rows('contact_phone_support',"id","company=".$company." and status=1");
