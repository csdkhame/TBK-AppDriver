...
<h1 style="font-family:Arial, Helvetica, sans-serif;background-color:#FFFFFF; padding:5px; padding-right:10px; border-bottom: solid 1px #999999; box-shadow: 0 0 5px 3px #E8E6E6; font-size:22px     " >
      ...
      <ol class="breadcrumb"   >
	   ...
	   <h1 style="font-family:Arial, Helvetica, sans-serif;background-color: #3C8DBC; padding:5px; padding-top:10px; margin-top:10px; margin-left: 0px;  padding-right:10px; border-bottom: solid 2px #FFFFFF; box-shadow: 0 0 5px 3px #E8E6E6;   " >
