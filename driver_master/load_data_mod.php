...
?>    
  ...
  $('.back-full-popup-mod-button-show').click(function(){   

   $( "#load_data_main_popup" ).toggle();
 
    $( "#load_data_main_popup" ).html('');
  ...
  <tr>
    <td width="40"   ><div class="back-full-popup-mod-button-show" ><i class="fa fa-arrow-circle-left" style="font-size:22px; color:#FFFFFF "></div></i></td>
