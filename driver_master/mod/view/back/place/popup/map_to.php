...
<div id="alert_show_map_to_<? echo $arr[project][id];?>" style="display:none;z-index:99999">
<div class="outer-container" >
   <div class="inner-container">  <img src="images/close-popup.png" width="50" height="50" alt="" style="margin-top:-45px; position:absolute; margin-left:240px; margin-top:-10px; cursor:pointer" id="close_alert_show_map_to_<? echo $arr[project][id];?>"/>
