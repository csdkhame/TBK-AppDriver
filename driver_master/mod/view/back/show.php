...
<? if($deposit>0){  ?>
 ...
 <? } ?>   
       ...
       <div  id="driver_use_car_<? echo $arr[project][id];?>" class="topictransfer1" style="border-radius: 25px ; padding:5px; background-color:#FFF;  border:2px solid #0072BC;  
 box-shadow: 0 0  0px   #E8E6E6; margin-top:15px; display:nones; padding-bottom: 5px; padding-left:5px;   "> 
