...
@copy ($_FILES['load_checkin_camera']['tmp_name'] , "../data/fileupload/store/usecar/".$driver_id."_".$_GET['number'].".jpg" );
...
@unlink("../car/pic/guest/".$_GET[type]."/".$_GET[folder]."/".$_GET['number'].".jpg");  
  }
