...
var url_pic = "go.php?name=load/show/photo_upload&file=upload_pic&id=<?=$arr[project][id];?>&folder=<?=$arr[project][invoice];?>&number=<?=$i?>&type=<?=$_GET[checkin]?>&action=del";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" style="display:none">
  <tbody>
    <tr>
      <td><?  include ("mod/checkcar/load/car/photo_upload/check.php");?></td>
    </tr>
  </tbody>
</table>
