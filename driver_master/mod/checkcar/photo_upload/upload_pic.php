...
// copy ($_FILES['load_chat_album']['tmp_name'] , "../data/1.png" ); 
 		 ...
 		 @copy ($_FILES['load_checkin_camera']['tmp_name'] , "../data/fileupload/store/car_repair/".$_GET[folder]."_".$_GET['number'].".png" );
...
@unlink("../data/fileupload/store/car_repair/".$_GET[folder]."_".$_GET['number'].".png");  
  }
