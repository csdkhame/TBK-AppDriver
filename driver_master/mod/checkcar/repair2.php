			...
			<div class="input-group" style="margin-top:10px; ">
                <label class="input-group-btn">
                    ...
                    <form  method="post" enctype="multipart/form-data" id="photo2">
                        <i class="fa  fa-camera"></i>&nbsp;ถ่ายภาพ<input type="file" class="form-control" name="photo_checkguest_2" id="photo_checkguest_2" accept="image/*"  capture="camera"  style="display: none;"/> </form>
                    </span>    
                </label>
...
//		uploadPhoto(id,input,filename);
   ...
   <div class="input-group">
                <label class="input-group-btn">
                    ...
                    <form  method="post" enctype="multipart/form-data" id="photo1">
                        <i class="fa  fa-camera"></i>&nbsp;ถ่ายภาพ<input type="file" class="form-control" name="photo_checkguest_3" id="photo_checkguest_3" accept="image/*"  capture="camera"  style="display: none;"/> </form>
                    </span>
                </label>
...
//	   uploadPhoto(id,input,filename);		
  ...
  <tr>
    <td style="padding-right:5px; "><textarea name="detail" rows="5" class="form-control" id="detail" required="true"></textarea></td>
    </tr>
</table>
...
return false ;
 ...
 /*$.post('popup.php?name=checkcar&file=savedata&type=repair&id=<?=$arr[web_driver][id]?>',$('#edit_form').serialize(),function(response){
...
function deletePhoto(id){
	...
	$('#url_photo_checkguest_'+id).css({"background": "#fa1431","color": "#333333", });
...
function readURL(input,id) {
  ...
  if (input.files && input.files[0]) {
    ...
    reader.onload = function(e) {
       ...
       $('#show_img_'+id).show();
       $('.btn-img-'+id).css('background-color','#23d666');
