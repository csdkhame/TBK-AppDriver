  ...
  <tr>
   ...
   .div-all-check-phone{
	 padding:5px;   border-radius:  30px; border: 1px solid #3C8DBC;background-color:#FFFFFF;     margin-bottom: 5px; box-shadow: 0px  0px 10px #DADADA; width:100%  ; margin-top:10px; font-size:40px;  
                            ...
                            <a href="tel:<?=$arr[other][insure_phone];?>" id="call_<?=$arr[private_phone][id]?>" >  
                            
                            
                            
                            
                            
 <table width="100%" border="0" cellspacing="2" cellpadding="2" class="div-all-check-phone">
 
    <tr>
      <td > <b><a href="tel:<?=$arr[other][insure_phone];?>" id="call_<?=$arr[private_phone][id]?>" style=" font-size:40px;" ><img src="images/icon/map/phone.png"   align="bottom"    />
 <?=$arr[other][insure_phone];?> </a></td>
    </tr>
