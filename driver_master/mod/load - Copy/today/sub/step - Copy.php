 ...
 $res[project] = $db->select_query("SELECT id,driver_pickup,driver_topoint,driver_complete,driver_checkcar FROM ".TB_transfer_report_all."  where id='".$_GET[bookid]."'");
...
<? if($arr[project][driver_topoint]== 0){?>
<a ><font color="#FF0000"><span class="text-alert"><?=$type?></font></a>
