...
<div style="padding: 5px 3px;">            
 <div class="box-header with-border" style="background: #ffffff;border-radius: 15px;border: 1px solid #ddd;">
          
	<div style="padding:0px 0px; margin: auto;margin-top: 5px">
		<table width="100%">
			<tbody><tr>
				<td width="33%"><div id="btn_new" class="btn_filter_active tocheck" align="center" onclick="FilterTypeRepair('new');"><span class="font-20">ยังไม่ยืนยัน</span>
				...
				<td width="33%"><div id="btn_progress" class="btn_filter tocheck" align="center" onclick="FilterTypeRepair('progress');"><span class="font-20">กำลังซ่อม</span>
				...
				<td width="33%"><div id="btn_complete" class="btn_filter tocheck" align="center" onclick="FilterTypeRepair('complete');"><span class="font-20">รับรถ</span>
...
function cancelRepair(id,driver_id){
	...
	swal({
	  ...
	  inputPlaceholder: "สาเหตุที่ปฏิเสธ"
	},
	function(inputValue){
		if (inputValue === false) return false;
		if (inputValue === "") {
		    swal.showInputError("กรุณากรอกเหตุผลหรือสาเหตุที่ปฏิเสธ!");
		    return false
		  }
