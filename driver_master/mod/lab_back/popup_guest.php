...
<center>
					 ...
					 <button type="button" class="btn-modal-ok"   style="background-color:<?=$ok_button_color?> "    id="btn_guest_yes_<? echo $arr[project][id];?>" data-target="#popup_confirm_guest_<?=$arr[project][id];?>" data-toggle="modal" data-backdrop="static" data-keyboard="false">ถูกต้อง</button>
