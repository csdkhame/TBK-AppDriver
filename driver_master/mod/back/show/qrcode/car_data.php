 <?
        ...
        $res[car] = $db->select_query("SELECT * FROM " . TB_carall . "  where  id=".$_GET[car]."");
...
<script>
   ...
   swal({
		...
		text: "<div style='margin-top:-10px;'><font style='font-size:34px;color:#333333''><b><?=$arr[type][topic_en]?> เบอร์  <?= $arr[car][car_num]?></b><br><font style='font-size:18px; color:#FF0000'><?=$arr[admin][company]?></div>",
		type: "success",
