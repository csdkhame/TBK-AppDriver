 ...
 $res[project] = $db->select_query("SELECT id,driver_pickup FROM ".TB_transfer_report_all."  where id='".$_GET[bookid]."'");
...
<div class="font_20" style="padding:5px;"><b>เช็คชื่อแขกสำเร็จ</div>
...
<div class="font_20" style="padding:5px; color:#FF0000"><b>ไม่เจอแขก</div>
