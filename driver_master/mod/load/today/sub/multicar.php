...
$res[projectcar] = $db->select_query("SELECT drivername FROM   transfer_report_all  where  invoice='".$arr[project][invoice]."' and drivername<>".$driver_id." group by drivername ");
