...
$('#btn_complete<?=$arr[project][id];?>').show();
 ...
 <table width="100%" border="0" cellspacing="2" cellpadding="2"  class="btn btn-default" style="border-radius: 35px ; padding:0px; background-color:#FFF;  border:2px solid #dadada; margin-bottom:10px; display:none"  id="btn_qr<?=$arr[project][id];?>">
    <tbody>
      <tr>
