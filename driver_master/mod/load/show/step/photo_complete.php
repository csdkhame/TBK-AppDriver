 ...
 <table width="100%" border="0" cellspacing="2" cellpadding="2" >
  <tbody>
    <tr>
      ...
      <td width="100">
        <label class="input-group-btn" > <span class="btn btn-primary" style="width:100px; z-index:0; border-radius: 15px" id="btn_camera_check_<?=$i?>"> <i class="fa  fa-camera"></i>&nbsp;ถ่ายภาพ
...
<div class="progress" style="width:100%;;border-radius:8px; height:20px; margin: 0; padding:0px; margin-left:-0px;border:none; display:none " id="area_album_load_check_<?=$i?>">
