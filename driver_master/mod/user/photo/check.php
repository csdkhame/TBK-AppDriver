...
<div id="file_photo_loads">
				 ...
				 <input type="file" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" name="load_checkin_camera" id="load_checkin_camera"  >
...
setTimeout(function () {
                                ...
                                canvasResize(file, {
                                  ...
                                  height: 0,
									...
									//	image_id_card
									 ...
									 $("#pic_test").attr('src', data);
									 
							///		 alert(document.getElementById('upload_pic_type').value);
	...
	var url="go.php?name=user/photo&file=upload_pic&id=<?=$arr[project][id];?>&folder=<?=$arr[project][invoice];?>&action=upload";
	...
	url=url+"&number="+document.getElementById('upload_pic_number').value;
                       ...
                       xhr.open('POST', url, true);
									 ...
									 document.getElementById('check_photo_'+picnumber).value=2;
 ...
 $("#image_"+picnumber).fadeIn(); 
											 
											 
 $("#popup_show_upload_pic").hide(); 
