...
<form method="post" action="" id="edit_form" name="edit_form" ctype="multipart/form-data" >
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                   ...
                   <div>
                    ...
                    <input class="form-control" type="text" name="username" id="username"   required="true"  onkeypress="UserEnter(this,event)" value="<?=$arr[web_driver][email];?>"    >
              </div>
  ...
  <tr>
    <td width="70%" >    <input type="text" name="line_id" id="line_id"  required="true" onkeypress="PasswordEnter(this,event)"  value="<?=$arr[web_driver][line_id];?>" class="form-control"  ></td>
	...
	<div class="btn-group">
          ...
          <li id="up_line_id"><a href="#">อัพไฟล์</a></li>
			...
			<font color="#FF0000">คุณยังไม่ได้อัพโหลดไฟล์ QR CODE </font>
                    ...
                    <input class="form-control" type="text" name="zello_id" id="zello_id"  required="true" onkeypress="PasswordEnter(this,event)"   value="<?=$arr[web_driver][zello_id];?>" >
                    </div>
	...
	<script type="text/javascript">
		...
		$(function() {
			$('#file_upload').uploadify({
				'formData'     : {
				 'name' : 'qrcode_<?=$arr[web_driver][id];?>',
