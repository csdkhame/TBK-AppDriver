...
?>
 ...
 ////// อัพเดทตำแหน่งตัวเอง 
 var url_check_data_time_chat = "<?=$chat_part?>load_blank.php?name=livechat/update&file=main&driver=<?=$driver_id?>&vc=<?=$_GET[vc]?>&order=<?=$_GET[order]?>&type=check_guest&chat_from=<?=$chat_from?>&chat_to=<?=$chat_to?>&chat_online=<?=chat_online?>&chat_offline=<?=chat_offline?>";
