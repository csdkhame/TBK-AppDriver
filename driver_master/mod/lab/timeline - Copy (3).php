...
/// map cn
 ...
 /*
$row_no = $db->num_rows(TB_transfer_report_all,"id","drivername='".$driver_id."' and transfer_date='".$daywork."' and status = 'CONFIRM' and driver_complete  ='0' group by driver_complete,invoice order by driver_complete desc   ");
$row_yes = $db->num_rows(TB_transfer_report_all,"id","drivername='".$driver_id."' and transfer_date='".$daywork."' and status = 'CONFIRM' and driver_complete  ='1' group by driver_complete,invoice order by driver_complete desc ");
...
var driver_remark_detail = $('#driver_remark_noguest_other').val();
	...
	//alert(driver_remark_detail);  
	  /////
	  /*
	   $.post('popup.php?name=lab&file=action&id=<?=$arr[web_driver][id]?>',
