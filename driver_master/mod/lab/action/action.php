...
$res[name] = $db->select_query("SELECT id,nickname,post_date,company,line_token FROM ".TB_driver." WHERE id='".$_GET[dv_old]."' ");
...
$res[drivernamenew] = $db->select_query("SELECT id,nickname,post_date,company,line_token FROM ".TB_driver." WHERE id='".$_GET[dv_new]."' ");
...
$worktype='new';
 ...
 include "mod/lab/action/line/create_line_vc.php";	
 
  include "mod/lab/action/line/send_line_vc.php";	
