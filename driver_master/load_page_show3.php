...
<div class="mobileSelect-container white" style="display: none;" id="popup_craftpip_1">
   <div class="" style="transition: all 0.4s;top: 20px;left: 20px;right: 20px;bottom: 80px;">
         ...
         <table width="100%">
            <tbody>
               <tr>
                ...
                <tr>
               		<td><input style="border-radius:15px;margin-top:5px;" type="text" class="form-control search_com_box" placeholder="ค้นหาจากชื่อยริษัท .." style="margin-top:5px;" onkeyup='filterNameCom();'  /></td>
               </tr>
            </tbody>
         </table>
      </div>
      <div class="list-container" id="list_popup_switch_1" style="margin-bottom:0px !important;margin-top:100px;"></div>
...
<div class="mobileSelect-container white" style="display: none;" id="popup_craftpip_2">
  ...
  <div class="close-small-popup" align="right" style="right:13px;margin-top: 7px;"><i class="fa fa-close close-craftpip-popup" style="font-size:30px; color:#333; "></i></div>
      ...
      <div class="list-container" id="list_popup_switch_2" style="margin-bottom:0px !important;margin-top:145px;"></div>
      <!--<div class="mobileSelect-buttons"><a href="#" class="mobileSelect-savebtn">ตกลง</a><a href="#" class="mobileSelect-cancelbtn">ยกเลิก</a></div>-->
   </div>
</div>