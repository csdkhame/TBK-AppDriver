...
@mkdir("data/filework_vc/".$_GET[day]."", 0777);      
@chmod("data/filework_vc/".$_GET[day]."", 0777);      



 
 shell_exec("./convert --width 600 --quality 90 https://www.welovetaxi.com/app/driver_master/today_loadworkvc_vc".$_GET[vc]."_day".$_GET[day].".html  /home/admin/domains/welovetaxi.com/private_html/app/driver_master/data/filework_vc/".$_GET[day]."/".$_GET[vc].".jpg > /dev/null & echo $!");
