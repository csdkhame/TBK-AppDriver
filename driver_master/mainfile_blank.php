...
///// หา sup
$res[web_sup] = $db->select_query("SELECT id,province FROM web_admin WHERE id='".$arr[web_driver][company]."'    "); 
...
$driver_zello=$arr[driver_network] [id_zello]; 
$callcenter_zello=$arr[callcenter_network] [id_zello]; 

$my_phone=$db->num_rows('contact_phone_driver',"id","driver_id='".$driver_id."'  "); 
