...
$('#load_update_th').load('<?=$transferlurl?>/app/crontab/update/driver_report_th.php?driver=<?=$driver_id?>');
//$('#load_update_th').load('load/page/loading.php');
$('#load_update_th').load('<?=$transferlurl?>/app/crontab/update/driver_report_cn.php?driver=<?=$driver_id?>');
