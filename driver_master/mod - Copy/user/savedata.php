...
$db->connectdb(DB_NAME, DB_USERNAME, DB_PASSWORD);
         $db->update_db(TB_driver, array(
		 	...
		 	"pic_card" => "$_POST[check_photo_card]",
			"pic_driver" => "$_POST[check_photo_driving]",
		...
		/// ../data/fileupload/store/driver_id
...
//// 
///@copy ($_FILES['load_checkin_camera']['tmp_name'] , "../car/pic/guest/".$_GET[type]."/".$_GET[folder]."/".$_GET['number'].".png" );

@copy ("../data/fileupload/store/driver_id/".$driver_id."_id_card.jpg", "../data/pic/driver/id_card/".$driver_id.".jpg" ); 
@copy ("../data/fileupload/store/driver_id/".$driver_id."_id_driving.jpg", "../data/pic/driver/id_driving/".$driver_id.".jpg" ); 

@unlink("../data/fileupload/store/driver_id/".$driver_id."_id_card.jpg");  
@unlink("../data/fileupload/store/driver_id/".$driver_id."_id_driving.jpg");  
		
		
		?>
		  
              <div class="alert alert-success alert-dismissible" style="margin-top:5px; margin-bottom:-10px; padding:10px; font-size:18px;border-radius: 25px; " id="save">
                     <i class="fa fa-check"></i>  บันทึกข้อมูลสำเร็จ
              </div>
