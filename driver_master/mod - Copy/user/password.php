...
<div>
		      ...
		      <input type="text" name="newpassword" id="newpassword"     value="<?=$arr[web_driver][password];?>"   class="form-control"  >
    </div>
...
return false ;
 ...
 $.post('popup.php?name=user&file=savedata&type=password&id=<?=$arr[web_driver][id]?>',$('#edit_form').serialize(),function(response){
