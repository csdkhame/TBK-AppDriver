...
<div class="select-car-now" id="div_car_<?=$arr[car][id]?>">
  ...
  <tbody>
    <tr>
      <td width="55" rowspan="3"><table width="100%" border="0" cellspacing="2" cellpadding="2" class="cirnumbershow-car" style="background-color:<?=$color?>">
        <tbody>
          <tr>
  ...
  <tbody>
    ...
    <tr>
      <td valign="top" class="font_18">ทะเบียน&nbsp;<b><? echo $arr[car][plate_num];?>&nbsp;<? echo $arr[car][province];?></td>
    </tr>
    <tr>
      <td valign="top" class="font_16"> 
        <?= $arr[admin][company]?>
      </b></td>
    </tr>
  </tbody>
