...
<img src="../data/images/logo/<?=$arr[chatuser][company];?>.jpg?v=<?=time()?>" width="55" height="55" border="0" class="mainpic_index"  style="border:solid 1px; border-color:#3C8DBC;border-radius:0px; margin-top:5px;" />
...
document.getElementById('all_user').value='<?=$sum_user?>';
 ...
 $('#td_btn_add_group').html('<button class="input-group-addon" style="background-color:#3C8DBC; width:50px;" id="btn_add_group"><i class="fa  fa-plus" style="font-size:24px; color:#FFFFFF"></i></button>');  
