...
//function send_work($driver = "",$vc = "",$day = "",$type= ""){
	
if($type=='new'){	
$typesend='มีงานใหม่เข้ามา';	
}
if($type=='change'){	
$typesend='ส่งงานต่อจาก';	
}
if($type=='cancel'){	
$typesend='ยกเลิกงานโดยฝ่ายจัดรถ';	
}
