...
$arr[company] = $db->fetch($res[company]);
 ...
 if(document.getElementById('sound_alert_change_new_to_reject').value==0){
 
 
  ion.sound.play("alert_change_new_to_reject");
  
  document.getElementById('sound_alert_change_new_to_reject').value=1;
...
<script>
 ...
 if(document.getElementById('sound_alert_change_new_to_ok').value==0){
 
 
  ion.sound.play("alert_change_new_to_ok");
  
  document.getElementById('sound_alert_change_new_to_ok').value=1;
