<div style="background-color:#FFF; margin-top:5px; margin-bottom:5px; padding: 2px 0px 2px 0px;border-radius: 20px;"   >
 ...
 ?>
   ...
   <a id="icon_timeline_show_map_pickup_<? echo $arr[project][id];?>" >
                      
                                         <img src="images/icon/map/map.png"   align="bottom"  width="30"     /><b>&nbsp;แผนที่นำทาง </a>
                                         
                                         <script>
 
$("#icon_timeline_show_map_pickup_<? echo $arr[project][id];?>").click(function(){   

 
 
  $("#alert_timeline_show_map_pickup_<? echo $arr[project][id];?>" ).toggle();
  ...
  <script>
 $("#close_alert_timeline_show_map_pickup_<? echo $arr[project][id];?>").click(function(){   
 
 $( "#alert_timeline_show_map_pickup_<? echo $arr[project][id];?>" ).hide();
