...
$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
$res[project] = $db->select_query("SELECT * FROM ".TB_order."  where drivername='".$driver_id."' and transfer_date='".$_GET[day]."' and carno = '".$_GET[carno]."' order by airin_h ASC,airin_time ASC  limit 1 ");
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><div style=" padding-top:5px;  color:#3C8DBC;font-size:18px;" ><b>
