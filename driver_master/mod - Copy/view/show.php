...
<? if($deposit>0){  ?>
 ...
 <div class="div-all-checkin-step" style="font-size:18px; padding:5px; color:#3C8DBC;padding-bottom: 10px; display:nones">   <b>
               
            <center>   ข้อมูลการใช้รถขณะนี้</center>
                     
                           
       <div  id="driver_use_car_<? echo $arr[project][id];?>" class="topictransfer1" style="border-radius: 25px ; padding:5px; background-color:#FFF;  border:2px solid #3C8DBC;  
