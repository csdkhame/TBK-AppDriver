...
.container .checkmark:after {
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 0px;">
      <tbody><tr>
         <td style="padding-right:0px; "><textarea name="detail" rows="5" class="form-control" id="detail" required></textarea></td>
      </tr>
   </tbody>
   </table>	
		<table width="100%" style="margin-top: 10px;">
                	<tr>
                		...
                		<button type="button" class="btn btn-danger btn-modal-no" style="width: 100%; font-size: 16px;border-radius: 25px;" id="close_confirm">ปิด</button> 
                		</td>
                		<td width="50%" align="center"> 
                		<button type="button" class="btn btn-success btn-modal-ok" style="width: 100%; font-size: 16px;border-radius: 25px;" id="submit_confirm">ยืนยัน</button> 
                		</td>
                	</tr>
        </table>
    </div>    
...
.checkmark {
    ...
    border-radius : 25px;border:  2px solid #51AADD;
}
...
.checkmark-icon {
    ...
    border-radius : 40px;border:   0px solid #dadada; margin-right:5px; box-shadow: 0px 0px  8px #DADADA;
}
...
.container .checkmark:after {
	...
	<div style="margin-top: 0px;margin-bottom: 5px;">
		<div style="margin-top:5px;margin-bottom: 10px; display:none"><center>&nbsp;<strong>อาการเสียหรือส่วนที่ต้องการให้บริการ</strong></div>
		<div style="padding-top: 5px;padding-bottom: 5px;padding-left: 3px;padding-right: 3px;">
		<div class="db">
		<?php 
 while ($arr[type_broken] = $db->fetch($res[type_broken])) { ?>
				<div style="padding: 10px; margin-bottom: 12px;border:1px solid #ddd;border-radius:  25px; /*box-shadow: 1px 1px 3px #999999;*/">
				<label class="container"><span class="font-btn-18" id="txt_bk_<?=$arr[type_broken][id];?>" ><span class="checkmark-icon"><i class="<? echo $arr[type_broken][icon];?>"  style="font-size: 16px; color:#333333"></i></span><?=$arr[type_broken][topic_th];?></span>
				  <input type="checkbox" value="<?=$arr[type_broken][id];?>" class="checkbox_broken"  > 
				  <span class="checkmark"></span>
				  <div id="detail_bk_<?=$arr[type_broken][id];?>" style="display: none;"><?=$arr[type_broken][detail];?></div>
				</label>
<input type="text" value="" class="form-control " style="display: none;margin-top: 15px;border-radius:  25px;" id="broken_txt_<?=$arr[type_broken][id];?>" placeholder="ใส่รายละเอียดเพิ่มเติม(ถ้ามี)"  />
				</div>
		<?	}
		?>
		</div>
		...
		<table width="100%" style="margin-top: 10px;">
                	<tr>
                		<td width="50%" align="center"> 
                		<button type="button" class="btn  btn-modal-no" style="width: 100%;" id="close_confirm">ปิด</button> 
                		</td>
                		<td width="50%" align="center"> 
                		<button type="button" class="btn  btn-modal-ok" style="width: 100%; " id="submit_confirm">ยืนยัน</button> 
                		</td>
                	</tr>
        </table>
    </div>    
