...
$res[chkcar] = $db->select_query("SELECT * FROM  driver_use_car  where drivername='".$arr[web_driver][id]."'  order by id desc limit 1 ");
...
<? if($arr[chkcar][type]<>'start'){ ?>
    ...
    <button id="submit_start" type="button" class="btn btn-block btn-primary" style="width:100%; font-size:20px; background-color: #00CC66; border:2px solid #FFFFFF; border-radius:25px;"><i class="icon-new-uniF156-1  faa-flash animated"></i>&nbsp;เริ่มใช้รถ</button>
	...
	<? } ?>
		...
		<button   type="button" class="btn btn-block btn-primary" style="width:100%; font-size:20px;  background-color: #CCCCCC   ; border:2px solid #FFFFFF; border-radius:25px; ">เริ่มใช้รถ</button>
	...
	<? if($arr[chkcar][type]=='start'){ ?>
	<button id="submit_stop" type="button" class="btn btn-block btn-primary" style="width:100%; font-size:20px; background-color: #FF0000   ; border:2px solid #FFFFFF; border-radius:25px;"><i class="icon-new-uniF11D-7  faa-flash animated"></i>&nbsp;หยุดใช้รถ</button>
	
	<? } ?>
	
		<? if($arr[chkcar][type]<>'start'){ ?>
	<button   type="button" class="btn btn-block btn-primary" style="width:100%; font-size:20px;  background-color: #CCCCCC   ; border:2px solid #FFFFFF; border-radius:25px; ">หยุดใช้รถ</button>
