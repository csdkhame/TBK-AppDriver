...
$db->add_db('driver_use_car',array(
 ...
 @copy ("../data/fileupload/store/usecar/".$_GET[drivername]."_1.jpg", "../data/fileupload/usecar/".$_GET[drivername]."_".TIMESTAMP."_1.jpg" ); 
 
  @copy ("../data/fileupload/store/usecar/".$_GET[drivername]."_2.jpg", "../data/fileupload/usecar/".$_GET[drivername]."_".TIMESTAMP."_2.jpg" ); 
...
@unlink("$folder_xml/driver/usecar/".$_GET[drivername].".xml");
@$fd = @fopen("$folder_xml/driver/usecar/".$_GET[drivername].".xml", "a+");
@fputs($fd, $product . "");
@fclose($fd);
