<? 
 ...
 $selectdata="driver_topoint,driver_pickup,driver_complete,driver_checkcar";
 
 $db->connectdb(DB_NAME_DATA,DB_USERNAME,DB_PASSWORD);
$res[to] = $db->select_query("SELECT  $selectdata FROM ".TB_transfer_report_all."  where id='".$_GET[bookid]."' limit 1");
