...
$('#btn_complete<?=$arr[project][id];?>').show();
 ...
 <table width="100%" border="0" cellspacing="2" cellpadding="2"  class="btn btn-default" style="border-radius: 35px ; padding:0px; background-color:#FFF;  border:2px solid #dadada; margin-bottom:10px; display:none5"  id="btn_qr<?=$arr[project][id];?>">
    <tbody>
      <tr>
        <td width="50"><img  id="qrimgs" src="mod/load/show/qrcode/c.png"   align="right" style="opacity: 1;"></td>
        <td align="left" class="font_18"><strong>คลิกเพื่อเลือกใช้</strong><br>
รถในงานนี้ใหม่</td>
      </tr>
    </tbody>
  </table>
