...
<div style="display: nonea">
 ...
 <div id="showDD"   style="display: nonea">  
...
////// Update  DB
var url_transfer="find.php?name=list/share_point&file=<?=$_GET[op];?>&lat="+my_Point.lat();
	url_transfer=url_transfer+"&lng="+my_Point.lng();
	url_transfer=url_transfer+"&id=<?=$_GET[id];?>";
$("#showDD").load(url_transfer);
