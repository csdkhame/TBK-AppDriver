...
<div data-role="content" class="ui-content" role="main" style="border:solid 1px #BBBBBB;padding:15px;margin:15px;">
        <ul id="ulLevel" class="iteList ulLevel" onclick="ulLevelClick(this,event);" >
<li style="text-align:center;"><img src="images/loading-large.gif"/></li>
        </ul>
   </div>
